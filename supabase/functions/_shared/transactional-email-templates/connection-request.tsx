...
const Email = ({ connectionName }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You have a new connection request on Wallly</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>New connection request</Heading>
        <Text style={text}>
          <strong>{connectionName || 'Someone'}</strong> sent you a connection request on Wallly.
...
export const template = {
  component: Email,
  subject: (d: Record<string, any>) => `${d?.connectionName ?? 'Someone'} wants to connect on Wallly`,
